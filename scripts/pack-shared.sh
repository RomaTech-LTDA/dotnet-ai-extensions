...
echo "========================================="
echo " Packing: Romatech.Extensions.Ai.Shared"
echo "========================================="
...
dotnet build "$SOLUTION_ROOT/src/Romatech.Extensions.Ai.Shared/Romatech.Extensions.Ai.Shared.csproj" -c "$CONFIGURATION"
